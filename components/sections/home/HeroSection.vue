                        ...
                        <h1 class="text-gray-800 pt-4 dark:text-white font-bold text-4xl md:text-5xl lg:text-6xl">
                            Zoek en beluister
                             <br>De <span
                                ...
                                van <br>Iris Enthoven
                        </h1>
                    </div>

                    <p class="text-gray-600 dark:text-gray-300 pt-8 text-center lg:text-left mx-auto max-w-xl">
                        Iedereen heeft een eigen verhaal. In deze podcast staan verschillende inspirerende mensen centraal die allemaal iets heftigs hebben meegemaakt maar in staat waren dit om te zetten in iets positiefs. Dan ben je een held. En dat verhaal moet verteld worden. 
                    </p>
