            ...
            <nav class="flex items-center justify-between w-full relative">
                ...
                <div class="inline-flex relative bg-inherit">
                    <NuxtLink to="/" class="flex items-center gap-2">
                        <img src="/logo.png" alt="App Logo" class="w-8 h-8 rounded-full object-cover">
                        <span class="text-lg text-gray-700 dark:text-white">Iris Enthoven</span>
                    </NuxtLink>
                </div>
                <div 
                ...
                <div class="flex items-center bg-inherit gap-1 lg:gap-3 min-w-max">
                    ...
                    <div class="hidden lg:flex lg:items-center gap-4">
                        <AtomsLinkBtn href="https://podcasters.spotify.com/pod/show/iris-enthoven/subscribe" variant="secondary">
                            Subscribe
                        </AtomsLinkBtn>
                        <AtomsLinkBtn href="#nieuwsbrief" variant="primary">
                            Nieuwsbrief
                        </AtomsLinkBtn>
                    </div>
                            ...
                            <template #content>
                                <ul class="flex flex-col">
                                    <li
                                        ...
                                        <NuxtLink to="https://podcasters.spotify.com/pod/show/iris-enthoven/subscribe">
                                            Subscribe
                                        </NuxtLink>
                                    </li>
